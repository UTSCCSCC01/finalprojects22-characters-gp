...
**Team Name:** [Characters-gp]  
**Github:** [https://github.com/UTSCCSCC01/finalprojects22-characters-gp]  
...
## summary.md (Max 8 marks)
  ...
  Feedback: There were some grammatical mistakes too. Please proof read before submitting. "Key Cases" section not required here.
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  - Writing (max 2 marks) 
    ...
    Feedback: 1. User story 2 not very clear. Any website can be accesed through phone. Do you want to develop separate mobile app? That does not look like a case. You may want to redraft that. 2. User story 13 is more of a task not a userstory.That should be part of the login/signup form. For User Story 13, benefit not clearly defined. Again User story 18 seems like a small task and not a user story.
...
## Process: process.md (max 10 marks)
  ...
  - Prioritizing user stories (max 2 marks)
    ...
    Your mark: 1
    Feedback: What happens after you estimate the user stories? Which one do you work on first?
