...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Some messages (July 26) do not start with ticket number 
    e.g created UI for the CustomerOrders Page and made minor UI changes to OrderDetails page e.t.c
...
## Sprint Demo (Max 14 marks) 
  - Attendance (max 2 marks) (5 Members)
  ...
  3 - Edit the product
  4 - Delete the story
  5 - Customers login page

Feeback: Buttons sticked together when deleting the story 
