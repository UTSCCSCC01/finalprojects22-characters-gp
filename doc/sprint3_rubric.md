...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 4 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    - 0 marks = No meeting document submitted or the submitted document contains no relevant information to the sprint N
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 0
    - Subtasks for Char-7 (Only one assigned), Char-19 and Char-69 not assigned
...
## Sprint Demo (Max 14 marks) 
  ...
  Feedback: Field Alignments would be nice for checkout 
---
